...
{
    /// <inheritdoc />
    public partial class AddLearningTranscriptListMoreColumns : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Adds i.GroupName/GroupOrgCode/GroupPath/UserStatus to the SELECT list so the report
            // table can show the same descriptive fields the source Skillport report itself has -
            // everything else in the procedure (joins, scoping WHERE clause, pagination) is
            // unchanged from FixLearningTranscriptManagerScoping.
...
END");
        ...
        {
            // No-op - see the other LearningTranscript SP-fix migrations for the same reasoning.
        }
    }
}
