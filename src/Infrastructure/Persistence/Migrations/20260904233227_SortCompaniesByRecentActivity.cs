...
{
    /// <inheritdoc />
    public partial class SortCompaniesByRecentActivity : Migration
    {
        /// <inheritdoc />
...
BEGIN
    ...
    SELECT
        ...
        c.PaymentForm, c.TotalPayment, c.PurchaseDate,
    ...
    -- Newest-added OR most-recently-edited first (UpdateDetails/SetLicense/SetPurchaseDate/
    -- UpdateLogo/Activate/Deactivate all stamp UpdatedAt - see Company.cs) instead of alphabetical,
    -- so a new or just-edited company always surfaces at the top of the list.
    ORDER BY COALESCE(c.UpdatedAt, c.CreatedAt) DESC, c.CompanyId DESC
